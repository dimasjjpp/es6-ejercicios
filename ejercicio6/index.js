...
const numberFinder = numbers.find((number) => number === 100)
...
const mutationFinder = mutations.find(
  (mutation) => mutation.name === 'Porompompero'
)
const alienFind = { ...alienFinder, mutation: mutationFinder }
console.log(alienFind)
